        ...
        <div class="layui-form-item">
            <div class="layui-inline">
                ...
                <div class="layui-input-inline">
                    <input type="text" class="layui-input" id="timeInfo" placeholder="开始 到 结束">
                </div>
        ...
        layui.use(['form', 'table', "laydate", 'layer'], function () {
            ...
            $("#select_btn").on('click', function () {
                ...
                if ($('#timeInfo').val() === '') {
                    ...
                    windows.location.href = "/operate/new_user?time=" + timeInfo
                    $.ajax({
                        //动态获取下拉选项的接口，返回数据主要是id+name
                        url: "/operate/new_user?time=" + timeInfo,
                        dataType: 'json',
                        type: 'get',
                        success: function (data) {
                            //  2023/2/16 0:0:0 - 2023/3/17 0:0:0
                            option = {
                                title: {
                                    text: 'Stacked Line'
                                },
